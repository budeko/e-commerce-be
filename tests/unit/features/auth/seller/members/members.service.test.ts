...
vi.mock('@/db/models/auth/seller-member.model', () => ({
  SellerMember: {
...
vi.mock('@/features/auth/seller/roles/roles.service', () => ({
  getSellerRoleSummariesByIds: (...args: unknown[]) => mockGetSellerRoleSummariesByIds(...args),
}));

import { getSellerMemberByUserId, listSellerMembers } from '@/features/auth/seller/members/members.service';
