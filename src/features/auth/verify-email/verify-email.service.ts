...
import { signAuthToken, type UserRole } from '../../../lib/auth/auth-token';
...
import { deleteUnverifiedUser } from '../../../lib/auth/unverified-user';
import { User } from '../../../db';
...
const markEmailVerified = async (userId: string) => {
  ...
  if (user.verificationExpiresAt && user.verificationExpiresAt < new Date()) {
    ...
    throw new RegisterError(410, 'Doğrulama süresi doldu, lütfen tekrar kayıt ol');
  }
