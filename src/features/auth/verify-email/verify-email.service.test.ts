...
import { signEmailVerificationToken } from '../../../lib/auth/email-token';
...
const { OtpError } = await import('../../../lib/auth/otp');
const { verifyEmail } = await import('./verify-email.service');
...
describe('verifyEmail', () => {
  ...
  describe('kod ile', () => {
    ...
    it('OTP hatasını RegisterError olarak iletir', async () => {
      mockFindOne.mockResolvedValue(unverifiedUser);
